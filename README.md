...
The template can be further customized using EXPERIMENT_OPTIONS. EXPERIMENT_OPTIONS is a list of key/value pairs. For example, an alternative ICGC project could be defined (for a project that supports such an option) using `-p project=BRCA-US`.
